...
namespace AlipayIntegrationMVC.Controllers
{
    public class PaymentController : Controller
    {
        ...
        public void SubmitAlipay()
        {
            ...
            //必填，不能修改
            //服务器异步通知页面路径
            string notify_url = "http://www.商户网址.com/payment/alipaynotify";
            //需http://格式的完整路径，不能加?id=123这类自定义参数

            //页面跳转同步通知页面路径
            string return_url = "http://www.商户网址.com/payment/alipayreturn";
            ...
            //商户订单号
            string out_trade_no = "换成唯一订单号";
            //商户网站订单系统中唯一订单号，必填

            //订单名称
            string subject = "换成订单名称";
            //必填
            ...
            string body = "换成订单描述";
            //商品展示地址
            string show_url = "http://www.商户网址.com/";
